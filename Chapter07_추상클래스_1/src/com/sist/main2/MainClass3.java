...
// BB b=new BB() ==> c,aaa(), bbb()  상속 받기 전
// 
public class MainClass3 {

	public static void main(String[] args) {
		System.out.println("========= AA ============");
		AA aa=new AA(); // AA에 설정된 변수나 메소드에만 접근이 가능
		...
		AA cc=new BB(); // 변수는 AA가 가지고 있는 것만 사용이 가능, 
		                // 메소드는 BB가 가지고 있는것을 호출
 ...
 *          |          |
 *      = 상속이 있는 경우에만 사용이 가능
 *      = 상속을 내리는 클래스와 상속받는 클래스가 변수, 메소드가 동일한 경우에만
