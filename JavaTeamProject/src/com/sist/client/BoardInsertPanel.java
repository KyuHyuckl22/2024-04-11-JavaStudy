...
public class BoardInsertPanel extends JPanel implements ActionListener {
	 JLabel titleLa,nameLa,subLa,contLa,pwdLa;
	    ...
	    public BoardInsertPanel(ControllPanel cp)
	    {
	    	...
	    	nameLa.setBounds(120, 100, 80, 30);
	    	nameTf.setBounds(205, 100, 150, 30);
	    	add(nameLa);add(nameTf);
	    	
	    	subLa=new JLabel("제목",JLabel.CENTER);
	    	subTf=new JTextField();
	    	subLa.setBounds(120, 135, 80, 30);
	    	subTf.setBounds(205, 135, 450, 30);
	    	add(subLa);add(subTf);
	    	...
	    	contLa.setBounds(120, 170, 80, 30);
	    	js.setBounds(205, 170, 900, 400);
	    	add(contLa);add(js);
	 
	    	pwdLa=new JLabel("비밀번호",JLabel.CENTER);
	    	pwdPf=new JPasswordField();
	    	//             Top  Right Bottom Left ==> CSS
	    	pwdLa.setBounds(120, 585, 80, 30);
	    	//             x  y width heigth
	    	pwdPf.setBounds(205, 585, 150, 30);
	    	add(pwdLa);add(pwdPf);
	    	...
	    	JPanel p=new JPanel();
	    	p.add(b1);p.add(b2);
	    	p.setBounds(120, 650, 900, 35); // 120, 650, 900, 35
	    	add(p);
