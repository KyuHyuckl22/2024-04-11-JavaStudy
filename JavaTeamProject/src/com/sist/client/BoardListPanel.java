...
//         
      ...
      int tableHeight = table.getRowHeight() * 10;
      js.setBounds(120, 180, 900, tableHeight); //330
      add(js); 
      //ta.setBounds(120, 200, 900, 415);
      JPanel p = new JPanel();
      p.add(b2); // 이전
      p.add(pageLa); // 1page / 4pages
      p.add(b3); // 다음

      p.setBounds(120, 650, 900, 35); // 페이지 위치
      add(p);
      print();
